            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p>All this awesome stuff couldnt be done by one small little team. We have people to thank for this.<br />>
                           So without further hassle, thank you:</p>
                            <ul>
                                <li>
                                    Google Api and their charts <a href="https://developers.google.com/chart/">Google Charts</a>
                                </li>
                                <li>
                                    All cool kinds of vendors:
                                    <ul>
                                        <li>
                                            jQuery
                                        </li>
                                        ...
                                        <li>
                                            raphael, Morris.js and Flot.js (altough not used in final version)
                                        </li>
                                        <li>
                                            Mentis menu's
                                        </li>
                                        <li>
                                            Boostrap 4 with Font-Awesome
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    Big thanks to sb-admin template for bootstrap, which we were allowed to use under MIT license <a href="https://startbootstrap.com/template-overviews/sb-admin/">SBADMIN</a>
                                </li>
                            </ul>
