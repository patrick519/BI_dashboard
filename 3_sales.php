            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php
                        $query = "SELECT * FROM sales ORDER BY saleId ASC ";
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            printf ("%s  %s", "<td>", "</td>");
                            printf ("%s %s %s", "<td>",$row["saleId"], "</td>");
                            printf ("%s %s %s", "<td>", $row["saleDateTime"], "</td>");
                            printf ("%s %s %s", "<td>", $row["accountName"], "</td>");
                            printf ("%s %s %s", "<td>", $row["coins"], "</td>");
                            printf ("%s %s %s", "<td>", $row["currency"], "</td>");
                            printf ("%s %s %s", "<td>", $row["priceInCurrency"], "</td>");
                            printf ("%s %s %s", "<td>", $row["priceInEUR"], "</td>");
                            printf ("%s %s %s", "<td>", $row["methodId"],"</td>");
                            printf ("%s %s %s", "<td>", $row["ip"], "</td>");
                            printf ("%s %s %s", "<td>", $row["ipCountry"], "</td>");
                            printf ("%s", "</tr>" );
                        }
